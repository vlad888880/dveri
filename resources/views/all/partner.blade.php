...
<body style="width: 80%; margin: 0 auto">
    ...
    <table class="table">
        ...
        <tbody>
            ...
            <tr>
                <th scope="row">
                    <form action="{{ route('partner_del', ['id' => $item->id_partner]) }}" method="post">
                        {{csrf_field()}}
                        {{method_field('DELETE')}}
                ...
                <th scope="row"><a href="{{ route('partner_open_edit', ['id' => $item->id_partner]) }}">
                <img src="{{ asset('resources/icons/edit.svg') }}" style="width: 1rem" alt=""></a></th>
                <td><img src="{{ asset('storage/app/partner') }}/{{ $item->img_partner }}" style="width: 4.2rem" alt="">
                </td>
